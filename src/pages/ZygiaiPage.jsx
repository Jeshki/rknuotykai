...
const ZygiaiPage = () => {
  ...
  const seo = <SEO title="Žygiai" description="Peržiūrėkite RK nuotykių žygių galeriją ir maršrutus." />;
  ...
  if (!archivedHikes.length) {
    return (
      <>
        {seo}
        <p className={`p-4 ${pageTextColor}`}>Šiuo metu nėra buvusių žygių. Laukite artimiausių atnaujinimų!</p>
      </>
    );
  }
